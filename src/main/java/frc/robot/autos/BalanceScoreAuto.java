...
public class BalanceScoreAuto extends SequentialCommandGroup {
    public BalanceScoreAuto(Swerve s_Swerve, Intake i_Intake, Shoulder s_Shoulder, Wrist w_Wrist){

        Command path = PathPlannerLoader.getAutoCommand(s_Swerve, "Center Balance");
